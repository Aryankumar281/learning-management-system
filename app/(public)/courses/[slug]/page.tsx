                        ...
                        <CardContent className="p-6 hover:bg-muted/50 transition-colors">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              <p className="flex justify-center items-center rounded-full bg-primary/10 size-10 text-primary font-semibold">
                                {index + 1}
                              </p>
                              <div>
                          ...
                          {chapter.lesson.map((lesson, lessonIndex) => (
                            ...
                            >
                              <div className="flex size-8 items-center justify-center rounded-full bg-background border-2 border-primary/20">
                                <IconPlayerPlay className="text-muted-foreground group-hover:text-primary transition-colors size-4" />
                              </div>
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Certifcate of completion</span>
                  </li>
                </ul>
              </div>
