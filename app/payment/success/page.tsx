      ...
      <Card className="w-[350px]">
        <CardContent>
          ...
          <div className="mt-3 text-center sm:mt-5 w-full">
            ...
            <p className="text-sm mt-2 text-muted-foreground tracking-tight text-balance">Congrats your payment was successfull .You should now have access to the course.</p>
